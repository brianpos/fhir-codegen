...
public class ElementDefinition_30_50 : ICrossVersionProcessor<ElementDefinition>, ICrossVersionExtractor<ElementDefinition>
{
	...
	public void Process(ISourceNode node, ElementDefinition current)
	{
		switch (node.Name)
		{
			...
			case "type":
				current.Type.Add(Extract30ElementDefinitionTypeRefComponent(current, node));
				break;
	...
	private ElementDefinition.TypeRefComponent Extract30ElementDefinitionTypeRefComponent(ElementDefinition ed, ISourceNode parent)
	{
